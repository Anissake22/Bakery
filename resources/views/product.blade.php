    ...
    <div class="container-xxl bg-light my-6 py-6 pt-0" >
        <div class="container">
            ...
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <h1 class="display-6 mb-4">Explore The products Of Our Bakery </h1>
            </div>
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="product-item d-flex flex-column bg-white rounded overflow-hidden h-100">
                        <div class="text-center p-4">
                            <div class="d-inline-block border border-primary rounded-pill px-3 mb-3"><p><strong>Price: </strong> {{ $product->price }} MAD</p></div>
                            <h3 class="mb-3">{{ $product->name_product}}</h3>

                        </div>
                        <div class="position-relative mt-auto" align="center">
                            <img class="img-fluid " src="{{ $product->image }}" alt="">
                            <div class="product-overlay">
                                <a class="btn btn-lg-square btn-outline-light rounded-circle" href="{{ route('add.to.cart', $product->id) }}"><i class="bi bi-cart"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
