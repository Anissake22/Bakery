...
<html lang="en">
    ...
    <body>
        ...
        <nav
            ...
            data-wow-delay="0.1s"
        >
            <a href="/admin/admin-index" class="navbar-brand ms-4 ms-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav mx-auto p-4 p-lg-0">
                    ...
                    <a href="/admin/admin-index" class="nav-item nav-link active">Home</a>
                    <a href="/admin/products/index" class="nav-item nav-link">Products</a>
                    <a href="/admin/bakingschool/index-classes"class="nav-item nav-link">Baking school</a>
                    <a href="/admin/reservation/index-places" class="nav-item nav-link ">Place Reservation</a>
...
@endguest
    ...
    <!-- Page Header Start -->
    <div class="container-fluid page-header py-6 wow fadeIn" data-wow-delay="0.1s" style="margin-bottom:0;height:17rem" >
        <div class="container text-center pt-5 pb-3">
            <h1 class="display-4 text-white animated slideInDown mb-3">Administrator Portal</h1>
        </div>
    </div>
    <!-- Page Header End -->
        <main class="py-4">
