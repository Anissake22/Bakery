        ...
        >
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav mx-auto p-4 p-lg-0">
                    ...
                    <a href="/place" class="nav-item nav-link active">Place Reservation</a>
...
@endguest
    ...
    <div class="container-fluid page-header py-6 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center pt-5 pb-3">
            <h1 class="display-4 text-white animated slideInDown mb-3">Place Reservation</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a class="text-white" href="/index">Home</a></li>
                    <li class="breadcrumb-item text-primary active" aria-current="page">Place Reservation</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <table class="table table-bordered" id="tableclass">
        ...
        <tr>
            ...
            <td>{{ $place->date_reservation_place }}</td>
            <td>{{ $place->status }}</td>
            @if($place->status == 'Validated' || $place->status == 'Rejected') 
                <td></td>
            @else  
                <td><a href={{"delete/".$place['id']}} class="btn btn-danger">Delete</a></td>
            @endif
