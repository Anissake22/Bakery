...
@endguest
    ...
    <div class="container-fluid page-header py-6 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center pt-5 pb-3">
            <h1 class="display-4 text-white animated slideInDown mb-3">Cart</h1>
...
<table id="cart" class="table table-hover table-condensed">
        ...
        @if(session('cart'))
            @foreach(session('cart') as $id => $details)
                ...
                <tr data-id="{{ $id }}">
                    ...
                    <td data-th="Price">{{ $details['price'] }} MAD</td>
                    <td data-th="Quantity">
                        <input type="number" value="{{ $details['quantity'] }}" class="form-control quantity updatecart" />
                    </td>
                    <td data-th="Subtotal" class="text-center">{{ $details['price'] * $details['quantity'] }} MAD</td>
    ...
    <tfoot>
        <tr>
            <td colspan="5" class="text-right"><h3><strong>Total {{ $total }} MAD</strong></h3></td>
        </tr>
        <tr>
